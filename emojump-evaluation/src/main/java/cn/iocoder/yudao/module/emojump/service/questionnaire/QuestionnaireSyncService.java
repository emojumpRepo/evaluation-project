...
public interface QuestionnaireSyncService {
     ...
     * @return 同步结果统计
     */
    QuestionnaireSyncResult manualSync();
    ...
    class QuestionnaireSyncResult {
        ...
        public String toString() {
            return String.format("QuestionnaireSyncResult{totalProcessed=%d, newAdded=%d, updated=%d, invalidated=%d, success=%s, errorMessage='%s'}",
                    totalProcessed, newAdded, updated, invalidated, success, errorMessage);
        }
    }
