...
@Schema(description = "管理后台 - 测评 Response VO")
@Data
public class AssessmentRespVO {
    ...
    private List<AssessmentQuestionnaireRespVO> questionnaires;
    ...
    @Schema(description = "测评问卷信息")
    @Data
    public static class AssessmentQuestionnaireRespVO {
        ...
        @Schema(description = "问卷描述", example = "用于评估焦虑水平的标准量表")
