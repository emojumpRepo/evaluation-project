...
public class SurveyStatusComparator {
    ...
    public static class StatusChangeResult {
        ...
        public Boolean getOldIsOpen() {
            return oldIsOpen;
        }

        public void setOldIsOpen(Boolean oldIsOpen) {
        ...
        public void setNewIsOpen(Boolean newIsOpen) {
    ...
    public static StatusChangeResult compareStatus(QuestionnaireDO localQuestionnaire, ExternalSurveyRespVO externalSurvey) {
        ...
        Boolean oldIsOpen = localQuestionnaire.getIsOpen();
        ...
        if (statusChanged || isOpenChanged) {
            ...
            if (isOpenChanged) {
                ...
                description.append(String.format("开放状态: %s -> %s", 
                    oldIsOpen ? "开放" : "关闭", newIsOpen ? "开放" : "关闭"));
            }
