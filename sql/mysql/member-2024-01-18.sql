...
CREATE TABLE `member_user`  (
  ...
  `family_role` tinyint NULL DEFAULT 0 COMMENT '家庭角色',
...
-- ----------------------------
-- Table structure for member_baby
-- ----------------------------
DROP TABLE IF EXISTS `member_baby`;
CREATE TABLE `member_baby`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '宝宝ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '宝宝姓名',
  `birthday` date NOT NULL COMMENT '宝宝生日',
  `gender` tinyint NOT NULL COMMENT '性别：1-男，2-女',
  `height` decimal(5,2) NULL DEFAULT NULL COMMENT '身高(cm)',
  `weight` decimal(5,2) NULL DEFAULT NULL COMMENT '体重(kg)',
  `birth_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '生育方式',
  `guardian` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监护人',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '宝宝头像',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '宝宝信息';
