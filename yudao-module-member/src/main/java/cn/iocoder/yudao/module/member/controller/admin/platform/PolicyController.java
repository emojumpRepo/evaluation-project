...
import cn.iocoder.yudao.module.member.controller.admin.platform.vo.policy.*;
...
public class PolicyController {
    ...
    @PreAuthorize("@ss.hasPermission('member:policy:update')")
    ...
    @PreAuthorize("@ss.hasPermission('member:policy:query')")
    ...
    @PreAuthorize("@ss.hasPermission('member:policy:export')")
